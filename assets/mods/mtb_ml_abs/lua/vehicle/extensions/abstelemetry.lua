...
local function resetAccum()
  ...
  lastBrakeAvgGy = 0; lastBrakeAvgG = 0; lastBrakeDist = 0
...
local function onPhysicsStep(dtPhys)
  ...
  elseif brakeState == "measuring" then
    if airspeed <= 1 then
      ...
      print(string.format("=== BRAKE EVENT DONE: dist=%.2fm avgDecel=%.2f gravity=%.4f avgG=%.4f ===",
        distance, avgDeceleration, gravity, avgDeceleration / -gravity))
